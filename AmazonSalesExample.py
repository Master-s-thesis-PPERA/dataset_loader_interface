...
def amazonsales():
  ...
  ratings2 = loader.load_dataset_useful_columns()
  print(ratings2.head())
  ...
  df_hidden_column = loader.hide_information(test_data, hide_type="columns", columns_to_hide="product_id")
  ...
  df_hidden_values_multiple = loader.hide_information(test_data, hide_type="values_in_column", columns_to_hide=['rating', 'actual_price'], fraction_to_hide=0.3)
